...
impl ConstraintSolver {
    ...
    pub fn assert(&mut self, var: Var, t: Type) -> Var {
    ...
    pub fn assert_multi(&mut self, var: Var, types: Vec<Type>) -> Var {
        let constraint = Rc::new(Constraint::Assert {
            var,
    ...
    pub fn assign(&mut self, to: Var, from: Var) -> Var {
