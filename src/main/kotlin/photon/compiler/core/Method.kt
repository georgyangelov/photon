...
//  protected abstract fun call(vararg args: Any): Any
  ...
  abstract fun callMethod(target: Any, args: Array<out Any>, evalMode: EvalMode): Any
  ...
  abstract class Default: Method() {
    final override fun callMethod(target: Any, args: Array<out Any>, evalMode: EvalMode): Any {
      when (evalMode) {
